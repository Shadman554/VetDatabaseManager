...
export default function Notifications() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Notifications Management</h2>
        <p className="text-gray-600">Create and manage system notifications for users</p>
      </div>
