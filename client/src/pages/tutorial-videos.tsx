...
export default function TutorialVideos() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-foreground mb-2">Tutorial Videos Management</h2>
        <p className="text-muted-foreground">Add and manage educational video content</p>
      </div>
